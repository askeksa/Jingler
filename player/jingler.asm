; Playback code for Jingler music
; Copyright (c) 2018-2026 Aske Simon Christensen
;
...
; AI notice
;
; The code in this file is written without the use of AI-based code generation
; and assistance tools. This means you can include it in your intro and still
; be in compliance with competition rules that prohibit or restrict the
; inclusion of generative AI content.
